...
class QuizState extends State<Quiz> {
  ...
  List<Question> availableQuizQuestions = [];
  ...
  Widget build(BuildContext context) {
    if (availableQuizQuestions.isEmpty) {
      ...
      Question currentQuestion = availableQuizQuestions[currentPageIndex];

      return Scaffold(
        backgroundColor: const Color.fromARGB(255, 141, 189, 173),
        appBar: AppBar(
          backgroundColor: const Color.fromARGB(255, 142, 227, 139),
          foregroundColor: const Color.fromARGB(255, 0, 0, 0),
          title: const Text('Quiz Easy'),
        ),
        body: Padding(
