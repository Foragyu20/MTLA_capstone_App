...
class Quizm extends StatefulWidget {
  const Quizm({Key? key}) : super(key: key);

  @override
  QuizmState createState() => QuizmState();
}
...
class QuizmState extends State<Quizm> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 242, 129, 76),
      appBar: AppBar(
        backgroundColor:const Color.fromARGB(255, 218, 81, 18),
        foregroundColor: const Color.fromARGB(255, 0, 0, 0),
        title: const Text('Quiz Moderate'),
      ),
      body: Padding(
          ...
          ElevatedButton(
            ...
            style: ButtonStyle(
              ...
              overlayColor: MaterialStateProperty.all(
                const Color.fromARGB(255, 218, 81, 18),
              ),
            ),
            child: Text(option),
          ),
